        ...
        <div id="carouselExampleSlidesOnly" className="carousel slide p-5" data-bs-ride="carousel">
            <div className="carousel-inner text-center">
                <div className="carousel-item active">
                    <p className="mb-3"
                        style={{ textTransform: 'uppercase', fontSize: '20px', fontFamily: 'Lato, sans-serif' }}>
                    ...
                    <p className="fw-bold" style={{ fontSize: '16px', fontFamily: 'Lato, sans-serif' }}>Juan Pérez</p>
                ...
                <div className="carousel-item">
                    ...
                    <p className="fw-bold" style={{ fontSize: '16px', fontFamily: 'Lato, sans-serif' }}>María López</p>
                ...
                <div className="carousel-item">
                    ...
                    <p className="fw-bold" style={{ fontSize: '16px', fontFamily: 'Lato, sans-serif' }}>Carlos Ramírez</p>
